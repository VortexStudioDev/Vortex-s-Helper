-- Vortex's Helper v2.0
-- Tasarım: Daha küçük, daha modern ve daha iyi
-- Önceki: Nameless Hub
-- Geliştirici: Vortex's Helper Team
...
local settingsFileName = "VortexHelperSettings.json"
...
local oldGui = PlayerGui:FindFirstChild("VortexHelperGui")
if oldGui then oldGui:Destroy() end

local screenGui = Instance.new("ScreenGui")
screenGui.Name = "VortexHelperGui"
screenGui.ResetOnSpawn = false
screenGui.Parent = PlayerGui

-- Ana frame - daha küçük boyut
...
mainFrame.BackgroundColor3 = Color3.fromRGB(10, 10, 20) -- Koyu mavi-siyah tema
...
-- Vortex logosu - daha kompakt
local vortexLabel = Instance.new("TextLabel")
vortexLabel.Name = "VortexLabel"
vortexLabel.Size = UDim2.new(0, 45, 0, 45)
vortexLabel.Position = UDim2.new(0, 0, 0, 0)
vortexLabel.BackgroundTransparency = 1
vortexLabel.Text = "VH"
vortexLabel.TextColor3 = Color3.fromRGB(0, 150, 255) -- Mavi tema
vortexLabel.TextScaled = true
vortexLabel.Font = Enum.Font.GothamBlack
vortexLabel.TextXAlignment = Enum.TextXAlignment.Center
vortexLabel.TextYAlignment = Enum.TextYAlignment.Center
vortexLabel.Parent = mainFrame

local helperLabel = Instance.new("TextLabel")
helperLabel.Size = UDim2.new(0, 45, 0, 15)
helperLabel.Position = UDim2.new(0, 0, 0, 25)
helperLabel.BackgroundTransparency = 1
helperLabel.Text = "Helper"
helperLabel.TextColor3 = Color3.fromRGB(200, 200, 255)
helperLabel.TextScaled = true
helperLabel.Font = Enum.Font.GothamBold
helperLabel.TextTransparency = 1
helperLabel.Visible = false
helperLabel.Parent = mainFrame
...
closeButton.BackgroundColor3 = Color3.fromRGB(30, 30, 50)
closeButton.Text = "✕"
...
-- Daha kompakt tab butonları
local function createTabButton(name, yOffset)
    local button = Instance.new("TextButton")
    button.Size = UDim2.new(0.28, -8, 0, 35)
...
local tabMain = createTabButton("Main", 80)
local tabSettings = createTabButton("Settings", 120)
local tabESP = createTabButton("ESP", 160)
local tabInfo = createTabButton("Info", 200)

local divider = Instance.new("Frame")
divider.Size = UDim2.new(0, 1.5, 1, -15)
divider.Position = UDim2.new(0.28, 0, 0, 8)
...
-- Tab içerikleri - daha kompakt tasarım
local function createTabContent(name)
    local contentFrame = Instance.new("Frame")
    contentFrame.Size = UDim2.new(1.15, -10, 1, -70)
    contentFrame.Position = UDim2.new(0.28, 35, 0, 70)
    ...
    if name == "Main" then
        ...
        infiniteJumpButton.Size = UDim2.new(0, 220, 0, 35)
        infiniteJumpButton.Position = UDim2.new(0, -25, 0, 5)
        infiniteJumpButton.BackgroundColor3 = Color3.fromRGB(20, 20, 40)
        infiniteJumpButton.Text = infiniteJumpEnabled and "Disable Infinite Jump" or "Enable Infinite Jump"
        infiniteJumpButton.TextColor3 = Color3.fromRGB(200, 220, 255)
        ...
        actionButton.Position = UDim2.new(0, -25, 0, 45)
        actionButton.BackgroundColor3 = Color3.fromRGB(20, 20, 40)
        actionButton.Text = walkspeedEnabled and "Disable Walkspeed" or "Enable Walkspeed"
        actionButton.TextColor3 = Color3.fromRGB(200, 220, 255)
        ...
        speedTextBox.Size = UDim2.new(0, 35, 0, 35)
        speedTextBox.Position = UDim2.new(0, 150, 0, 0)
        speedTextBox.BackgroundColor3 = Color3.fromRGB(15, 15, 30)
        ...
        tweenStealButton.Size = UDim2.new(0, 220, 0, 35)
        tweenStealButton.Position = UDim2.new(0, -25, 0, 85)
        tweenStealButton.BackgroundColor3 = Color3.fromRGB(20, 20, 40)
        tweenStealButton.Text = "Tween Steal"
        tweenStealButton.TextColor3 = Color3.fromRGB(200, 220, 255)
        tweenStealButton.TextSize = 12
        ...
        tweenButtonCorner.CornerRadius = UDim.new(0, 6)
        ...
        touchFlingButton.Size = UDim2.new(0, 220, 0, 35)
        touchFlingButton.Position = UDim2.new(0, -25, 0, 125)
        touchFlingButton.BackgroundColor3 = Color3.fromRGB(20, 20, 40)
        touchFlingButton.Text = flingEnabled and "Disable Touch Fling" or "Enable Touch Fling"
        touchFlingButton.TextColor3 = Color3.fromRGB(200, 220, 255)
        touchFlingButton.TextSize = 12
        ...
        touchFlingButton.MouseButton1Click:Connect(function()
            ...
            if flingEnabled then
                ...
                if not ReplicatedStorage:FindFirstChild("vortex_fling_marker") then
                    local marker = Instance.new("Decal")
                    marker.Name = "vortex_fling_marker"
        ...
        boostJumpButton.Size = UDim2.new(0, 180, 0, 35)
        boostJumpButton.Position = UDim2.new(0, -25, 0, 165)
        boostJumpButton.BackgroundColor3 = Color3.fromRGB(20, 20, 40)
        boostJumpButton.Text = boostJumpEnabled and "Disable Boost Jump" or "Enable Boost Jump"
        boostJumpButton.TextColor3 = Color3.fromRGB(200, 220, 255)
        boostJumpButton.TextSize = 12
        ...
        boostJumpCorner.CornerRadius = UDim.new(0, 6)

        local boostTextBox = Instance.new("TextBox")
        boostTextBox.Size = UDim2.new(0, 35, 0, 35)
        boostTextBox.Position = UDim2.new(0, 150, 0, 0)
        boostTextBox.BackgroundColor3 = Color3.fromRGB(15, 15, 30)
        boostTextBox.Text = tostring(currentBoostStrength)
        boostTextBox.TextColor3 = Color3.fromRGB(255, 255, 255)
        boostTextBox.TextSize = 12
        ...
        boostTextBoxCorner.CornerRadius = UDim.new(0, 6)
    ...
    elseif name == "Settings" then
        ...
        antiHitButton.Size = UDim2.new(0, 220, 0, 35)
        antiHitButton.Position = UDim2.new(0, -25, 0, 5)
        antiHitButton.BackgroundColor3 = Color3.fromRGB(20, 20, 40)
        antiHitButton.Text = antiHitEnabled and "Disable Anti Hit" or "Enable Anti Hit"
        antiHitButton.TextColor3 = Color3.fromRGB(200, 220, 255)
        antiHitButton.TextSize = 12
        ...
        antiTrapButton.Size = UDim2.new(0, 220, 0, 35)
        antiTrapButton.Position = UDim2.new(0, -25, 0, 45)
        antiTrapButton.BackgroundColor3 = Color3.fromRGB(20, 20, 40)
        antiTrapButton.Text = antiTrapEnabled and "Disable Anti Trap" or "Enable Anti Trap"
        antiTrapButton.TextColor3 = Color3.fromRGB(200, 220, 255)
        ...
        antiTrapButtonCorner.CornerRadius = UDim.new(0, 6)
    ...
    elseif name == "ESP" then
        ...
        timerEspButton.Size = UDim2.new(0, 220, 0, 35)
        timerEspButton.Position = UDim2.new(0, -25, 0, 45)
        timerEspButton.BackgroundColor3 = Color3.fromRGB(20, 20, 40)
        timerEspButton.Text = timerEspEnabled and "Disable Timer ESP" or "Enable Timer ESP"
        timerEspButton.TextColor3 = Color3.fromRGB(200, 220, 255)
        timerEspButton.TextSize = 12
        ...
        timerButtonCorner.CornerRadius = UDim.new(0, 6)
        ...
        webSlingerButton.Size = UDim2.new(0, 220, 0, 35)
        webSlingerButton.Position = UDim2.new(0, -25, 0, 85)
        webSlingerButton.BackgroundColor3 = Color3.fromRGB(20, 20, 40)
        webSlingerButton.Text = webSlingerAutoAimEnabled and "Disable Web Slinger Auto Aim" or "Enable Web Slinger Auto Aim"
        webSlingerButton.TextColor3 = Color3.fromRGB(200, 220, 255)
        webSlingerButton.TextSize = 12
        ...
        webSlingerButtonCorner.CornerRadius = UDim.new(0, 6)
        ...
        brainrotButton.Size = UDim2.new(0, 220, 0, 35)
        brainrotButton.Position = UDim2.new(0, -25, 0, 125)
        brainrotButton.BackgroundColor3 = Color3.fromRGB(20, 20, 40)
        brainrotButton.Text = brainrotEspEnabled and "Disable Highest Value ESP" or "Enable Highest Value ESP"
        brainrotButton.TextColor3 = Color3.fromRGB(200, 220, 255)
        brainrotButton.TextSize = 12
        ...
        brainrotButtonCorner.CornerRadius = UDim.new(0, 6)
    ...
    elseif name == "Info" then
        ...
        discordButton.Size = UDim2.new(0, 220, 0, 35)
        discordButton.Position = UDim2.new(0, -25, 0, 5)
        discordButton.BackgroundColor3 = Color3.fromRGB(20, 20, 40)
        discordButton.Text = "Copy Discord"
        discordButton.TextColor3 = Color3.fromRGB(200, 220, 255)
...
-- Açılış animasyonu - daha hızlı ve kompakt
local function openGUI()
    ...
    vortexLabel.TextXAlignment = Enum.TextXAlignment.Left
    vortexLabel.TextYAlignment = Enum.TextYAlignment.Top

    local sizeTween = TweenService:Create(mainFrame, tweenInfo, {
        Size = UDim2.new(0, 350, 0, 250), -- Daha küçük boyut
    ...
    local vortexMoveTween = TweenService:Create(vortexLabel, tweenInfo, {
        Position = UDim2.new(0, 12, 0, 12),
        Size = UDim2.new(0, 80, 0, 25)
    })
    local helperMoveTween = TweenService:Create(helperLabel, tweenInfo, {
        Position = UDim2.new(0, 20, 0, 30),
        Size = UDim2.new(0, 100, 0, 18)
    })
    local textTween = TweenService:Create(vortexLabel, tweenInfo, {
        TextTransparency = 1
    })
    local helperTextTween = TweenService:Create(helperLabel, TweenInfo.new(0.25), {
        TextTransparency = 0
    })

    sizeTween:Play()
    cornerTween:Play()
    vortexMoveTween:Play()
    helperMoveTween:Play()
    textTween:Play()
    helperTextTween:Play()

    textTween.Completed:Connect(function()
        vortexLabel.Text = "Vortex's"
        local nameTween = TweenService:Create(vortexLabel, TweenInfo.new(0.25), {
            TextTransparency = 0
        })
        local helperTween = TweenService:Create(helperLabel, TweenInfo.new(0.25), {
            TextTransparency = 0
        })
        nameTween:Play()
        helperTween:Play()
    ...
    -- Daha hızlı fade-in animasyonları
    local tabFadeIns = {
...
local function closeGUI()
    ...
    local vortexResetTween = TweenService:Create(vortexLabel, tweenInfo, {
        Position = UDim2.new(0, 0, 0, 0),
        Size = UDim2.new(0, 45, 0, 45)
    })
    local helperResetTween = TweenService:Create(helperLabel, tweenInfo, {
    ...
    sizeTween:Play()
    cornerTween:Play()
    vortexResetTween:Play()
    helperResetTween:Play()
...
-- Ayarları yükle ve özellikleri etkinleştir
task.wait(1)
...
StarterGui:SetCore("SendNotification", {
    Title = "Vortex's Helper v2.0",
    Text = "Yenilendi! Daha küçük ve daha iyi!",
    Duration = 5
})
