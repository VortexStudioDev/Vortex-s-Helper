...
local function finishFly(success)
    cleanupFly()
    if success then
        showNotification("Successfully flew to base!", true)
    end
end
...
mainFrame.Size = UDim2.new(0, 150, 0, 160) -- Daha küçük
...
header.Size = UDim2.new(1, 0, 0, 25) -- Daha küçük
...
tab1Btn.TextSize = 10 -- Daha küçük
...
tab2Btn.TextSize = 10 -- Daha küçük
...
contentTab1.Size = UDim2.new(1, -8, 1, -30) -- Boşluk kapatıldı
contentTab1.Position = UDim2.new(0, 4, 0, 26) -- Boşluk kapatıldı
...
contentTab2.Size = UDim2.new(1, -8, 1, -30) -- Boşluk kapatıldı
contentTab2.Position = UDim2.new(0, 4, 0, 26) -- Boşluk kapatıldı
...
local function createButton(parent, text, yPos, callback, isActive)
    ...
    btn.Size = UDim2.new(0.95, 0, 0, 22) -- Daha küçük buton
    btn.Position = UDim2.new(0.025, 0, 0, yPos)
    btn.BackgroundColor3 = isActive and Color3.fromRGB(60, 220, 100) or Color3.fromRGB(220, 60, 60) -- Yeşil/Kırmızı
    btn.Text = text
...
print("💾 Settings Saving: VortexHelper Folder")-- Vortex Helper - Premium Version
-- Features: Inf Jump, FLY TO BASE, FPS Devourer, ESP Base, ESP Best, Deysnc, Player ESP, Steal Floor
