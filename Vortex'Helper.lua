...
local function showNotification(message, isSuccess)
    ...
    -- TWEEN BİTTİKTEN SONRA 1.5 SANİYE BEKLE
...
-- FIXED Reset character - Roblox standard reset
...
-- Enhanced system information for Tab 2
...
-- Fixed copy to clipboard function with EKRANDA bildirim
...
-- Content area for Tab 3 - Job ID Joiner
...
-- Fixed Copy Job ID button for Tab 2
...
local function switchTab(tabNumber)
    ...
    elseif tabNumber == 2 then
        ...
        -- Update system info when switching to tab 2
...
-- Fixed Copy Job ID button event with EKRANDA bildirim
